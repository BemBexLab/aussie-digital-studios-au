...
const Cards = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full my-20 relative">
      ...
      <div className="hidden md:block absolute top-0 right-0 translate-y-[15px] -translate-x-32 z-10 pointer-events-none">
        <Image
      ...
      {/* Responsive Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 w-full px-4 md:w-fit md:px-0">
        {/* Reusable Card Component (applied to all 6 cards) */}
        {[
          {
