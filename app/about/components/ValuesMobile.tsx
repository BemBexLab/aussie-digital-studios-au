        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <div className="flex flex-col">
              ...
              <div className="mt-3 flex flex-col">
                <h2 className="text-base sm:text-lg font-semibold" style={{ color: isLight ? "#417AB8" : "#FBBF24" }}>Creativity</h2>
                <p className="font-light text-xs sm:text-sm">We believe in innovative solutions that stand out.</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col">
              ...
              <div className="mt-3 flex flex-col">
                <h2 className="text-base sm:text-lg font-semibold" style={{ color: isLight ? "#417AB8" : "#FBBF24" }}>Reliability</h2>
                <p className="font-light text-xs sm:text-sm">We're committed to delivering results you can count on.</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col">
              ...
              <div className="mt-3 flex flex-col">
                <h2 className="text-base sm:text-lg font-semibold" style={{ color: isLight ? "#417AB8" : "#FBBF24" }}>Australian-driven</h2>
                <p className="font-light text-xs sm:text-sm">We take pride in providing a local, personalised experience.</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col">
              ...
              <div className="mt-3 flex flex-col">
                <h2 className="text-base sm:text-lg font-semibold" style={{ color: isLight ? "#417AB8" : "#FBBF24" }}>Long-term</h2>
                <p className="font-light text-xs sm:text-sm">Our goal is to build lasting relationships and help your brand grow.</p>
              </div>
            </div>
          </div>
