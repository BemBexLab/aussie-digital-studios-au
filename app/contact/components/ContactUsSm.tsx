            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
              ...
              <div className="pt-2 text-center">
                <button
                  type="submit"
                  disabled={loading}
                  className="px-5 py-2 text-sm bg-teal-500 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-blue-400 text-white rounded-full transition-all inline-flex items-center justify-center group relative z-20 pointer-events-auto"
                >
