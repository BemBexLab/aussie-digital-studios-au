  ...
  return (
    <div className="relative overflow-x-hidden">
      ...
      <div className="my-10 md:my-30">
        <div className="text-center px-4 md:mx-20">
          <p className="text-lg text-emerald-400 mb-2 font-semibold">
            Job Opportunities
          </p>
          <h2 className="text-3xl md:text-4xl md:text-5xl font-semibold text-white">
            Job Openings
          </h2>
        </div>

        {/* Job Listing cards */}
        <div className="space-y-4 max-w-5xl mx-auto my-6 md:my-10 px-4 md:px-0">
          {[...Array(3)].map((_, idx) => (
            <div
              key={idx}
              className="bg-[#1F1F1F] bg-opacity-50 backdrop-blur border border-gray-600 rounded-xl p-4 md:px-6 md:py-3 hover:border-teal-500 transition-colors"
            >
              {/* Flex container: full-width, stretched layout on md+ */}
              <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full gap-3 md:gap-6">
                <h3 className="text-lg font-medium text-white">
                  Business Development Manager
                </h3>
                {/* Karachi visible on small screens */}
                <div className="md:hidden text-gray-300 text-sm">Karachi</div>
                ...
                <div className="hidden md:flex items-center gap-6">
                  <div
                    ...
                    aria-hidden="true"
                  />
                  <div className="text-gray-300 text-sm">Karachi</div>
                  ...
                  <div
                    ...
                    aria-hidden="true"
                  />
                  <div className="text-gray-300 text-sm">Full Time</div>
                </div>

                {/* Apply Button — no ml-auto needed */}
                <div className="mt-2 md:mt-0 w-full md:w-auto">
                  <button className="w-full md:w-auto px-3 py-2 bg-teal-500 hover:bg-teal-600 text-white rounded-full font-medium inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors">
                    Apply Now
