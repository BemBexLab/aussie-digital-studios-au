    ...
    data: [
      {
        ...
        discountedFrom: "$599",
        includes: [
          "Custom homepage design (3 pages)",
          "Dynamic and sleek layout with responsive design (Desktop, iPhone, Android, etc.)",
          "Online reservation/appointment tools",
          "Hover effects & interactive jQuery slider banner",
          "10 services/products listing",
          "5 premium stock photos",
          "Parallax scrolling effect",
          "Complete deployment",
          "24-hour turnaround with dedicated account manager",
          "24/7 support",
          "10 Revisions",
          "100% ownership rights",
      ...
      },
      {
        ...
        includes: [
          "Custom homepage design (6 pages)",
          "Dynamic and sleek layout with responsive design (Desktop, iPhone, Android, etc.)",
          "Online reservation/appointment tools",
          "Hover effects & interactive jQuery slider banner",
          "Payment Gateway Integration",
          "30 services/products listing",
          ...
          "Live social media feed widget (Facebook, Instagram, Pinterest)",
          "Complete deployment",
          "24-hour turnaround with dedicated account manager",
          "24/7 support",
          "10 Revisions",
      ...
      },
      {
        ...
        includes: [
          ...
          "Strategic conversion-focused layout",
          "Modern, sleek, high-end UI/UX",
          "Fully responsive (Desktop, iPhone, Android, Tablet)",
          "Mobile-first optimization",
          "Advanced hover effects",
          "Interactive jQuery slider banner",
          "Parallax scrolling & smooth animations",
          "Video banner integration",
          "Online reservation / appointment system with automated confirmations",
          "Advanced booking management system",
          "Payment Gateway Integration (Stripe, PayPal, Square, etc.)",
          "Up to 50 services/products listing",
          "Lead capture forms with auto-email notifications",
          "Dedicated senior project manager",
          "24/7 priority support",
          "48-hour turnaround (depending on content readiness)",
