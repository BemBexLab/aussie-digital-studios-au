            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                ...
                >
                  <span>{item}</span>
                  <span
                    className={`mt-1 h-2 w-2 rounded-full ${active ? "bg-[#4C8C74]" : "bg-transparent"}`}
                  />
                </Link>
              );
            })}
